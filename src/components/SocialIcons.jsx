...
const SocialIcons = () => {
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/ManojKumarAchanta",
      icon: (
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/manojkumarachanta",
      icon: (
    ...
    {
      name: "Instagram",
      url: "https://instagram.com/manoj_kumar_achanta",
      icon: (
        <div className="relative w-8 h-8">
          <svg className="w-full h-8 text-gray-900" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "LeetCode",
      url: "https://leetcode.com/manojkumarachanta",
      icon: (
        <svg className="w-8 h-8 text-gray-900" viewBox="0 0 24 24">
    ...
    {
      name: "Twitter",
      url: "https://twitter.com/manojkumar_dev",
      icon: (
        <svg className="w-8 h-8 text-gray-900" fill="currentColor" viewBox="0 0 24 24">
